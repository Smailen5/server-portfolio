...
describe("syncValidator", () => {
  ...
  it("fallisce quando chiave troppo corta", async () => {
    ...
    expect(
      result.array().some((e) => e.msg.includes("Chiave API non valida"))
    ).toBe(true);
  });
    ...
    const result = await runValidation(
      {
        headers: {
          "x-api-key":
            "A1bC2dE3fG4hI5jK6lM7nO8pQ9rS0tU1vW2xY3zA1bC2dE3fG4hI5jK6lM7nO8pQ9r",
        },
      },
      syncValidator
    );
    ...
    const result = await runValidation(
      {
        headers: {
          "x-api-key":
            "A1bC2dE3fG4hI5jK6lM7nO8pQ9rS0tU1vW2xY3zA1bC2dE3fG4hI5jK6lM7nO8pQ",
        },
      },
      syncValidator
    );
